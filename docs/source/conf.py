...
latex_documents = [
    (
        ...
        "dbkeator@uci.edu, camille.maumet@inria.fr, satrajit.ghosh@gmail.com, djarecka@gmail.com",
        "manual",
    ),
]
...
man_pages = [(master_doc, "pynidm", "PyNIDM Documentation", [author], 1)]
