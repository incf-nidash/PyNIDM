#nidm_linreg.py -nl [NIDM FILES] –independent_vars FIELD1,FIELD2 –dependent_var FIELD3
#!/usr/bin/env python
...
def query(nidm_file_list, cde_file_list, query_file, output_file, get_participants, get_instruments, get_instrument_vars, get_dataelements, get_brainvols,get_dataelements_brainvols, get_independent_vars, get_dependent_var, uri, j, verbosity):
    """
