...
class NIDMExperimentAcquisitionObject(NIDMExperimentCore):
    ...
    def addAcquisitionObject(self, study_id):
        ...
        #add to graph
        self.graph.add((self.namespaces["nidm"][self.uuid], rdf.RDF.type, Constants.NIDM_ACQUISITION_OBJECT))
    ...
    def addParticipant(self,identifier, acq_obj):
        ...
        self.addURIRef(person,"prov","hadRole", Constants.NIDM_PARTICIPANT)
        return person
